...
path_to_game = "galaxy_v1-2-1/src/"

Builder.load_file(f"{path_to_game}menu.kv")

module = map(__import__, [f"{path_to_game}transforms"])

class MainWidget(RelativeLayout):
	from module import transform, tranform_perspective, transform_2D
	...
	def init_audio(self):
		self.sound_begin = SoundLoader.load(f"{path_to_game}audio/begin.wav")
		self.sound_galaxy = SoundLoader.load(f"{path_to_game}audio/galaxy.wav")
		self.sound_gameover_impact = SoundLoader.load(f"{path_to_game}audio/gameover_impact.wav")
		self.sound_gameover_voice = SoundLoader.load(f"{path_to_game}audio/gameover_voice.wav")
		self.sound_music1 = SoundLoader.load(f"{path_to_game}audio/music1.wav")
		self.sound_restart = SoundLoader.load(f"{path_to_game}audio/restart.wav")
	...
	def init_ship(self):
		with self.canvas:
			...
			self.ship = Rectangle(pos=(self.width/2, 10), size=(75, 75), source=f"{path_to_game}images/ship2.png")
			print(self.width)
